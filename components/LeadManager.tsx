            ...
            {lead.analysis ? (
              <div className="space-y-3 text-sm">
                ...
                <div className="mt-4 pt-4 border-t border-slate-200 space-y-4">
                  ...
                  <button onClick={handleGenerateOutreach} disabled={generating} className="w-full bg-slate-800 text-white py-2 rounded-lg flex items-center justify-center gap-2 transition">
