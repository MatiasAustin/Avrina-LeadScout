      ...
      <div className="absolute top-4 right-4 z-10">
         <div className="flex items-center gap-1 bg-slate-50 p-1 rounded-lg border border-slate-200 shadow-sm">
             <button 
               ...
               className={`text-xs font-bold px-3 py-1.5 rounded ${language === 'en' ? 'bg-slate-800 text-slate-50' : 'text-slate-500 hover:bg-slate-100'}`}
             >
               EN
             </button>
             <button 
               onClick={() => setLanguage('id')}
               className={`text-xs font-bold px-3 py-1.5 rounded ${language === 'id' ? 'bg-slate-800 text-slate-50' : 'text-slate-500 hover:bg-slate-100'}`}
             >
               ID
             </button>
         </div>
