    ...
    <div className="h-screen flex flex-col bg-slate-100 overflow-hidden transition-colors duration-300 relative">
      ...
      <div className="flex flex-1 flex-col md:flex-row overflow-hidden relative z-30">
        ...
        <aside 
          ...
          `}
        >
          {/* Mobile Close Button - Sticky top */}
          <div className="md:hidden flex justify-between items-center p-4 pb-0 flex-shrink-0">
            <div className="flex items-center gap-2">
              {config.appLogo ? (
              ...
              <span className="font-bold text-slate-800 text-sm">{config.appName || 'Avrina LeadScout'}</span>
            </div>
            <button 
              onClick={() => setSidebarOpen(false)}
          ...
          <div className="flex-1 overflow-y-auto overflow-x-hidden">
            ...
            <div className="p-6 pb-2">
              <h1 className="text-xl font-bold text-slate-800 flex items-center gap-3">
                ...
                <span className="hidden md:inline">{config.appName || 'Avrina LeadScout'}</span>
              </h1>
            ...
            {/* Bottom Section - now scrollable with rest of content */}
            <div className="p-3 mt-4 space-y-2 border-t border-slate-100 bg-slate-50/50">
